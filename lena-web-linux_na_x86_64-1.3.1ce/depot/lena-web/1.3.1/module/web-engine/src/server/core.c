...
static const char *apache_server_description = NULL; /**LENA**/
...
AP_DECLARE(const char *) ap_get_apache_server_description(void) /**LENA**/
{
    return apache_server_description ? apache_server_description : AP_APACHE_SERVER_VERSION; /**LENA**/
}
...
static void set_banner(apr_pool_t *pconf)
{
    if (ap_server_tokens == SrvTk_PRODUCT_ONLY) {
        ap_add_version_component(pconf, AP_SERVER_BASEPRODUCTONLYNAME); /**LENA**/
    }
