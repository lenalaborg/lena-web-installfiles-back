...
typedef struct {
	...
	apr_time_t lena_dns_modified_time;	/**LENA**/
} proxy_worker_shared;
...
/**LENA-START**/
apr_hash_t *lena_lookup_target;
apr_interval_time_t lena_dns_ttl;
apr_pool_t *lena_pool;
apr_time_t lena_dns_modified_time;
int lena_dns_ttl_trace;
int lena_dns_ttl_trace_detail;
/**LENA-END**/
#endif /*MOD_PROXY_H*/
/** @} */
