...
JK_DECLARE(int) jk_map_alloc(jk_map_t **m);

JK_DECLARE(int) jk_map_free(jk_map_t **m);
...
JK_DECLARE(int) jk_map_read_property(jk_map_t *m, jk_map_t *env, const char *str, int treatment, jk_logger_t *l);

JK_DECLARE(int) jk_map_read_properties(jk_map_t *m, jk_map_t *env, const char *f, time_t *modified, int treatment, jk_logger_t *l);
...
JK_DECLARE(int) jk_map_copy(jk_map_t *src, jk_map_t *dst);
