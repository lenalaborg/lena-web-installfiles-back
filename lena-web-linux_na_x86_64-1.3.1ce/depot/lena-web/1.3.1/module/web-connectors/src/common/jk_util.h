...
JK_DECLARE(const char *) jk_get_worker_type(jk_map_t *m, const char *wname);
...
JK_DECLARE(int) jk_get_worker_list(jk_map_t *m, char ***list, unsigned *num_of_workers);
...
JK_DECLARE(int) jk_file_exists(const char *f);
