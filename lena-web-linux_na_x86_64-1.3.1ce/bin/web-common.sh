...
ROOT_PROJECT_PATH=${1}
. ${ROOT_PROJECT_PATH}/etc/info/web-server-compile.info
...
is_default_package_installed() {
    ...
    if [ "${_web_server_type}" = "apache-server" ]; then
    	_check_packages=${DEFAULT_OS_PACKAGES_22}
	fi
